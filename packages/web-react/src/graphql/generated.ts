...
export type MutationResolvers<ContextType = any, ParentType extends ResolversParentTypes['Mutation'] = ResolversParentTypes['Mutation']> = {
  ...
  removeFisherfolkGear?: Resolver<ResolversTypes['Gear'], ParentType, ContextType, RequireFields<MutationRemoveFisherfolkGearArgs, 'id'>>;
...
export type MutationRemoveFisherfolkGearArgs = {
  id: Scalars['Int'];
};
...
export type RemoveFisherfolkGearMutationVariables = Exact<{
  gearId: Scalars['Int'];
}>;


export type RemoveFisherfolkGearMutation = { __typename?: 'Mutation', removeFisherfolkGear: { __typename?: 'Gear', id: any } };
...
export const RemoveFisherfolkGearDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"RemoveFisherfolkGear"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"gearId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"Int"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"removeFisherfolkGear"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"id"},"value":{"kind":"Variable","name":{"kind":"Name","value":"gearId"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}}]}}]}}]} as unknown as DocumentNode<RemoveFisherfolkGearMutation, RemoveFisherfolkGearMutationVariables>;
