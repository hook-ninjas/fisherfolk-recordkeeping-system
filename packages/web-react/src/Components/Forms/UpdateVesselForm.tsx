          ...
          <Grid container spacing={-2} sx={{ ml: 1, mt: 1 }}>
            ...
            <Grid item sm={6} sx={{ mt: 1, ml: 0 }}>
              <FormInputNumber
                ...
                control={control}
                label="Year Built"
                defaultValue={vessel && yearBuilt?.toString()}
                register={register}
                errors={errors}
                shouldUnregister
          ...
          <Grid container spacing={-2} sx={{ ml: 1, mt: 1 }}>
            <Grid item sm={6}>
              <FormInputNumber
                ...
                defaultValue={vessel && registeredLength?.toString()}
                register={register}
                errors={errors}
                shouldUnregister
            ...
            <Grid item sm={6}>
              <FormInputNumber
                ...
                defaultValue={vessel && registeredDepth?.toString()}
                register={register}
                errors={errors}
                shouldUnregister
                sx={{ width: 230, marginLeft: 0.4 }}
          ...
          <Grid container spacing={-2} sx={{ ml: 1, mt: 1 }}>
            <Grid item sm={6}>
              <FormInputNumber
                ...
                defaultValue={vessel && registeredBreadth?.toString()}
                register={register}
                errors={errors}
                shouldUnregister
                sx={{ width: 230, marginLeft: 0.4 }}
            ...
            <Grid item sm={6}>
              <FormInputNumber
                ...
                defaultValue={vessel && tonnageLength?.toString()}
                register={register}
                errors={errors}
                shouldUnregister
                sx={{ width: 230, marginLeft: 0.4 }}
          ...
          <Grid container spacing={-2} sx={{ ml: 1, mt: 1 }}>
            <Grid item sm={6}>
              <FormInputNumber
                ...
                control={control}
                label="Tonnage Depth"
                defaultValue={vessel && tonnageDepth?.toString()}
                register={register}
                errors={errors}
                shouldUnregister
                sx={{ width: 230, marginLeft: 0.4 }}
            ...
            <Grid item sm={6}>
              <FormInputNumber
                ...
                defaultValue={vessel && tonnageBreadth?.toString()}
                register={register}
                errors={errors}
                shouldUnregister
                sx={{ width: 230, marginLeft: 0.4 }}
          ...
          <Grid container spacing={-2} sx={{ ml: 1, mt: 1 }}>
            <Grid item sm={6}>
              <FormInputNumber
                ...
                control={control}
                label="Gross Tonnage"
                defaultValue={vessel && grossTonnage?.toString()}
                register={register}
                errors={errors}
                shouldUnregister
                sx={{ width: 230, marginLeft: 0.4 }}
            ...
            <Grid item sm={6}>
              <FormInputNumber
                ...
                control={control}
                label="Net Tonnage"
                defaultValue={vessel && netTonnage?.toString()}
                register={register}
                errors={errors}
                shouldUnregister
                sx={{ width: 230, marginLeft: 0.4 }}
          ...
          <Grid container spacing={-2} sx={{ ml: 1, mt: 1 }}>
            <Grid item sm={6} sx={{ mt: -1 }}>
              <FormInputNumber
                ...
                control={control}
                label="Horsepower"
                defaultValue={vessel && horsepower?.toString()}
                register={register}
                errors={errors}
                shouldUnregister
                sx={{ width: 230, marginLeft: 0.4 }}
